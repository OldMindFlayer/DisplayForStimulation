...
class Display:
    def __init__(self, q_from_display_to_listener):
        self.path_action = config.config['general']['root_path'] + '/pictures_action/'
        self.path_object = config.config['general']['root_path'] + '/pictures_object/'
        self.path_other = config.config['general']['root_path'] + '/pictures_other/'
        self.path_sound = config.config['general']['root_path'] + '/sounds/tone.wav'
...
if __name__ == '__main__':
    ...
    if config.config['general'].getboolean('root_path_autogeneration'):
        config.config['general']['root_path'] = str(Path('display_for_stimulation.py').resolve().parents[0])
